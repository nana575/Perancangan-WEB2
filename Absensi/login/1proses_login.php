...
if ($user['is_verified'] == 0) {
    ...
    try {
        ...
        $link = "http://localhost/perancangan_WEB2/absensi/login/verify_email.php?token=$token";
...
switch ($user['role']) {
    case 'admin':
        header("Location: /perancangan_WEB2/absensi/admin/4dashboard_admin.php");
        break;

    case 'mahasiswa':
        header("Location: /perancangan_WEB2/absensi/mahasiswa/dashboard_mahasiswa.php");
        break;

    case 'dosen':
        header("Location: /perancangan_WEB2/absensi/dosen/dashboard_dosen.php");
        break;

    case 'kaprodi':
        header("Location: /perancangan_WEB2/absensi/kaprodi/dashboard_kaprodi.php");
        break;
