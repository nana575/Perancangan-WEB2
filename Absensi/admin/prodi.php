...
<div class="sidebar">
    ...
    <div class="collapse show submenu" id="dataMaster">
        ...
        <a href="prodi.php" class="text-white fw-semibold">
...
<div class="content">
    ...
    <p class="text-muted">Kelola data program studi</p>

    <div class="d-flex justify-content-between mb-3">
        <input type="text" id="search" class="form-control w-50" placeholder="Cari nama prodi...">
        <a href="2tambah_prodi.php" class="btn btn-primary">
                ...
                <table class="table table-sm table-bordered table-hover align-middle text-nowrap">
                    ...
                    <?php $no=1; while($row=mysqli_fetch_assoc($query)){ ?>
                        <tr>
                            ...
                            <td><?= $row['jenjang'] ?? '-' ?></td>
                            <td class="col-aksi">
                                <a href="edit_prodi.php?id=<?= $row['id_Prodi'] ?>" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <a href="3hapus_data.php?id=<?= $row['id_Prodi'] ?>"
