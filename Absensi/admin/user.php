...
<div class="sidebar">
    ...
    <div class="collapse show submenu" id="dataMaster">
        ...
        <a href="user.php" class="text-white fw-semibold">
...
<div class="content">
    ...
    <div class="d-flex justify-content-between mb-3">
        <input type="text" id="search" class="form-control w-50" placeholder="Cari nama / username...">
                    ...
                    <?php $no=1; while($row=mysqli_fetch_assoc($query)){ ?>
                        <tr>
                            ...
                            <td class="col-aksi">
                                ...
                                <a href="3hapus_data.php?id=<?= $row['id_user'] ?>"
